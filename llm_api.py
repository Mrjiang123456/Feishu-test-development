...
from config import API_URL, VOLC_BEARER_TOKEN, MODEL_NAME, MAX_TOKEN_SIZE
        ...
        try:
            ...
            async with session.post(
                ...
                if response.status != 200:
                    ...
                    log_error(f"LLM API调用失败，状态码: {response.status}，重试中 ({attempt+1}/{retries})", error_details)
                ...
                try:
                    ...
                    try:
                        ...
                        if is_markdown:
                            ...
                            return {"text": json_content.strip()}
